...
# with command line options: step3 --pileup_input das:/RelValMinBias_13/CMSSW_8_1_0-81X_upgrade2017_realistic_v26-v1/GEN-SIM --pileup AVE_35_BX_25ns -n -1 --conditions auto:phase1_2017_realistic --era Run2_2017_trackingPhase1CA --eventcontent RECOSIM,MINIAODSIM,DQM --runUnscheduled -s RAW2DIGI,L1Reco,RECO,EI,PAT,VALIDATION:@standardValidation+@miniAODValidation,DQM:@standardDQM+@miniAODDQM --datatier GEN-SIM-RECO,MINIAODSIM,DQMIO --filein file:step2.root --nThreads 1 --geometry DB:Extended --fileout step3.root
...
process = cms.Process('RECO',eras.Run2_2017_trackingPhase1CA)
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step3_inMINIAODSIM.root'),
