...
(X_train, y_train), (X_test, y_test) = ku.doubletsReadPost(detIn=dIn,detOu=dOu,datasets=datas,filedir='./Hits/',cols=size,rows=size,stack=pile)
...
for batchsize in batchsizes:
    for epoch in epochs:
        ...
        truesPath = './outputs/dets_' + str(dIn) + '_' + str(dOu) + '_batch_' + str(batchsize) + 'epoch' + str(epoch) + '_trues.out'
        falsesPath = './outputs/dets_' + str(dIn) + '_' + str(dOu) + '_batch_' + str(batchsize) + 'epoch' + str(epoch) + '_falses.out'
...
filePKName = './outputs/dets_' + str(dIn) + '_' + str(dOu) + '_batch_' + str(batchsize) + 'epoch' + str(epoch) + '.pik'
